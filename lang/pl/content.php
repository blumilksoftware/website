...
return [
    ...
    "about" => [
        ...
        "section_2" => [
            ...
            "stat_2" => "lat wspólnego doświadczenia",
            "stat_3" => "repozytoriów na GitHub",
            "stat_4" => "linii kodu tygodniowo",
        ],
        "section_3" => [
            "title_1" => "Nasze wartości",
            "subtitle_1" => "",
            "subtitle_2" => "W codziennej pracy stawiamy, innowacyjność i doskonałość techniczną.",
            "content_1" => "Pasja",
    ...
    "career" => [
        ...
        "section_3" => [
            ...
            "subtitle_1" => "Praktyki to doskonała okazja, aby zapoznać się z etosem pracy programisty, nawiązać kontakt z doświadczonymi profesjonalistami oraz zdobyć inspirację do dalszego rozwoju.",
        ],
        "section_4" => [
    ...
    "software_engineer" => [
        ...
        "section_2" => [
            "stack" => [
                ...
                "content_8" => "Google Workspace do dokumentów, e-maili, kalendarzy i innych",
