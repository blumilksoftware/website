...
return [
    "meta" => [
        "title" => "Cyfryzacja edukacji",
        "description" => "Rozwiązania cyfrowe dla nowoczesnej edukacji. Dla szkół, uczelni i instytucji. Prosto. Skutecznie. Bezpiecznie.",
    ],
    "navigation" => [
        "key_benefits" => "Korzyści",
        "our_solutions" => "Co oferujemy?",
        "case_studies" => "Realizacje",
        "contact" => "Kontakt",
    ],
    "hero_section" => [
        "title_1" => "Tworzymy",
    ...
    "contact" => [
        ...
        "description_1" => "Szukasz zaufanego partnera IT, który zna realia edukacji, a nie tylko deklaruje to w ofercie?",
        "description_2" => "Wypełnij formularz kontaktowy - skontaktujemy się z Tobą i porozmawiamy o rozwiązaniu idealnie dopasowanym do potrzeb Twojej instytucji.",
    ...
    "erasmus" => [
        ...
        "challenges" => [
            ...
            "tile_2" => [
                "title" => "Brak automatyzacji i niespójne dane",
