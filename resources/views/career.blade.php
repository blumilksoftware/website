...
@section("content")
        ...
        <div class="flex basis-2/5 relative flex-col self-center gap-5">
            ...
            <div class="flex flex-col items-center xl:items-start">
                <p class="text-sm md:text-lg font-normal text-center xl:text-start pb-12 md:pb-12">
                    <span class="leading-7">{{ __("content.career.section_1.subtitle_1") }}</span>
                </p>
                <p class="text-sm md:text-lg font-normal text-center xl:text-start">
                    <span class="leading-7 md:block">{{ __("content.career.section_1.subtitle_2") }}</span>
                    <span class="leading-7 font-semibold">{{ __("content.career.section_1.subtitle_3") }}</span>
                </p>
    ...
    <section class="relative">
        <div class="mx-[10%] lg:mx-[15%] 2xl:max-w-7xl 2xl:mx-auto md:space-y-10 pt-28 pb-20 md:pb-36">
            <div class="pb-10 md:pb-14 text-center">
                ...
                <span class="font-normal leading-7 text-sm md:text-lg relative">{{ __("content.career.section_2.subtitle_1") }}</span>
            </div>
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4 2xl:gap-12 xl:place-items-stretch">
                <div class="bg-gray-extra-light rounded-xl md:px-6">
                    <div class="flex flex-row leading-7 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-10 leading-7">
                ...
                <div class="bg-gray-extra-light rounded-xl md:px-6">
                    <div class="flex flex-row leading-7 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-3 2xl:pr-10 leading-7">
                ...
                <div class="bg-gray-extra-light rounded-xl md:px-6">
                    <div class="flex flex-row leading-7 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-6 md:pr-8 leading-7">
                ...
                <div class="bg-gray-extra-light rounded-xl md:px-6">
                    <div class="flex flex-row leading-7 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-24 leading-7">
    ...
    <section class="relative overflow-hidden space-y-4">
        <div class="flex flex-col md:mt-10 md:pb-5 xl:flex-row mx-[10%] lg:mx-[15%] 2xl:max-w-7xl 2xl:mx-auto gap-x-36">
            ...
            <div class="flex basis-2/5 relative flex-col justify-center md:pb-24 xl:pb-0">
                <div class="text-center xl:justify-start xl:text-start pb-5 xl:pb-10">
                    <h2 class="font-semibold text-gray-900 leading-12 text-md md:text-4xl lg:text-5xl mb-4 md:mb-10">{{ __("content.career.section_4.title_1") }}</h2>
                    <p class="text-xs md:text-lg font-normal text-center xl:text-start text-gray-500 leading-7 mx-8 md:mx-0">{{ __("content.career.section_4.subtitle_1") }}</p>
                </div>
        ...
        <img src="{{ asset('graphics/shadow.svg') }}" alt="" class="hidden md:block absolute -z-10 -right-[50%] -bottom-44"/>
        <img src="{{ asset('graphics/shadow.svg') }}" alt="" class="hidden md:block absolute -z-10 -left-[80%] top-40 object-cover"/>
