        ...
        <div class="flex basis-2/5 relative flex-col self-center gap-5">
            ...
            <div class="flex flex-col items-center xl:items-start">
                <p class="text-sm md:text-lg font-normal text-center xl:text-start pb-12 md:pb-12">
                    <span class="leading-7.5">{{ __("content.career.section_1.subtitle_1") }}</span>
                </p>
                <p class="text-sm md:text-lg font-normal text-center xl:text-start">
                    <span class="leading-7.5 md:block">{{ __("content.career.section_1.subtitle_2") }}</span>
            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4 2xl:gap-12 xl:place-items-stretch">
                <div class="bg-gray-extraLight rounded-xl md:px-6">
                    <div class="flex flex-row leading-7.5 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-10 leading-7.5">
                ...
                <div class="bg-gray-extraLight rounded-xl md:px-6">
                    <div class="flex flex-row leading-7.5 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-3 2xl:pr-10 leading-7.5">
                ...
                <div class="bg-gray-extraLight rounded-xl md:px-6">
                    <div class="flex flex-row leading-7.5 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-6 md:pr-8 leading-7.5">
                ...
                <div class="bg-gray-extraLight rounded-xl md:px-6">
                    <div class="flex flex-row leading-7.5 lg:text-lg py-6 w-fit h-full">
                        ...
                        <div class="self-center 2xl:mt-2 text-left">
                            <span class="font-semibold text-lg block pr-24 leading-7.5">
