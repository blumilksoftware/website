            ...
            <div class="container mx-auto text-center pt-24">
                <div class="items-center justify-center flex">
                    <div class="text-center">
                        <x-sitemap.tile>Logowanie</x-sitemap.tile>
                        <ul class="flex flex-row mt-10 justify-center">
                            <x-sitemap.bottom-line-vertical/>
                            <li class="relative p-6">
                                <x-sitemap.top-line-horizontal-full class="left-1/2 right-0"/>
                                <div class="relative flex justify-center">
                                    <x-sitemap.top-line-vertical/>
                                    <div class="text-center">
                                        <x-sitemap.tile>Usługi medyczne</x-sitemap.tile>

                                        <ul class="flex flex-row mt-10 justify-center">
                                            <x-sitemap.bottom-line-vertical/>
                                            <li class="relative p-6">
                                                <x-sitemap.top-line-horizontal-full class="left-[50%] right-0"/>
                                                <div class="relative flex justify-center">
                                                    <x-sitemap.top-line-vertical/>
                                                    <div class="text-center">
                                                        <x-sitemap.tile>Logowanie</x-sitemap.tile>
                                                        <ul class="flex flex-row mt-10 justify-center">
                                                                ...
                                                                <div class="relative flex justify-center">
                                                                    ...
                                                                    <div class="text-center">
                                                                        ...
                                                                        <ul class="flex flex-row mt-10 justify-center">
                                                                            ...
                                                                            <li class="relative p-6">
                                                                                <x-sitemap.top-line-horizontal-full class="left-0 right-1/2"/>
                                                                                <div class="relative flex justify-center">
                                                                                    <x-sitemap.top-line-vertical/>
                                                                                    <div class="text-center">
                                                                                        <div
                                                            ...
                                                            <li class="relative p-6">
                                                                <x-sitemap.top-line-horizontal-full class="left-0 right-0"/>
                                                                <div class="relative flex justify-center">
                                                                    <div
                            ...
                            <li class="relative p-6">
                                ...
                                <div class="relative flex justify-center">
                                    <x-sitemap.top-line-vertical/>
                                    <x-sitemap.tile>Usługi pielęgniarskie</x-sitemap.tile>
                                </div>
                            </li>
                        </ul>
                    </div>
