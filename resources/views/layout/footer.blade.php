                ...
                <div class="md:flex text-center justify-center lg:justify-end">
                    ...
                    <div class="flex justify-center space-x-6 md:order-2">
                        <a href="https://clutch.co/profile/blumilk-0" class="" target="_blank">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 lg:h-7 align-middle" viewBox="0 0 512 512">
                                <g fill="#ffffff">
                                    <path
                                ...
                                <g fill="#ffffff">
                                    <path
                                        d="M255.5 337 c-20.6 -3.7 -39.8 -15.2 -51.5 -30.6 -9.7 -12.8 -16.1 -30.8 -16.1 -45.1 0.1 -6.8 2.8 -19.5 6 -27.3 7.1 -17.9 24.2 -34.6 43 -42.3 13 -5.3 17.5 -6.1 33.5 -6.1 16 0.1 20.3 0.9 34.4 6.9 17 7.1 31.4 20.7 39.5 37.1 20.8 42.3 -2.9 91.4 -51 105.5 -7.9 2.3 -29.7 3.4 -37.8 1.9z"/>
                                </g>
                            </svg>
                        </a>
