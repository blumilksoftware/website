<footer>
    <div class="bg-gradient-to-t from-footer-dark to-footer-light">
        ...
        <div class="text-white justify-center padding py-16">
            <div class="flex flex-col justify-between lg:flex-row items-center gap-8">
                ...
                <div class="flex flex-col">
                    <div class="hidden md:flex bg-footer-light p-12 rounded-3xl bg-opacity-80">
                        <div>
                            <div class="flex gap-6">
                                ...
                                <div class="gap-12">
                                    ...
                                    <div class="text-sm leading-6 text-white break-words">{{__("footer.contactTo.job")}}</div>
                                    <div class="text-sm  text-white break-normal">{{__("footer.contactTo.description")}}</div>
                                    <div class="">
