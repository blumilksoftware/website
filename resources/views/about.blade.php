...
@section("content")
    ...
    <section class="relative flex flex-col-reverse lg:flex-row py-52 px-[10%] md:px-[20%]">
    ...
    <section class="bg-gray-light">
        <div class="flex flex-col lg:flex-row py-24 px-[10%] md:px-[20%]  duration-700 taos:translate-y-48 taos:opacity-0"
    ...
    <section class="relative pt-28 pb-24 text-center">
    ...
    <section class="bg-gradient-to-b from-gray-light to-white">
        ...
        <div class="relative flex flex-col xl:flex-row text-center md:text-left px-[10%] md:px-[20%] gap-x-16 py-8 xl:py-28 z-20">
            <div class="flex flex-col basis-1/3">
                <div class="relative duration-700 taos:translate-y-48 taos:opacity-0 text-center xl:text-left"
                     data-taos-offset="200">
            ...
            <div class="flex xl:hidden">
                <div class="size-full 2xl:size-52 3xl:size-72 delay-300 duration-1000 taos:scale-75 taos:opacity-0"
                     data-taos-offset="400">
                    ...
                    <div class="grid grid-rows-2 place-items-center gap-2 2xl:gap-6">
                        <div class="grid grid-cols-3 place-content-evenly gap-2 2xl:gap-6">
                            ...
                            <div class="grid grid-rows-2 justify-self-center gap-2 2xl:gap-6">
                                <div class="h-16 2xl:size-24 3xl:size-32 delay-300 duration-1000 taos:scale-75 taos:opacity-0"
                                     data-taos-offset="400">
                        ...
                        <div class="h-36 2xl:h-52 3xl:h-72 w-full place-items-center delay-300 duration-1000 taos:scale-75 taos:opacity-0"
                             data-taos-offset="400">
                            <img src="{{ asset('images/photos/birthday.jpg') }}" class="h-full w-full object-cover rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl transform transition hover:scale-110" alt="placeholder"/>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-1 place-items-center">
                    <div class="grid grid-rows-2 gap-2 2xl:gap-6">
                        <div class="size-36 2xl:size-52 3xl:size-72 delay-300 duration-1000 taos:scale-75 taos:opacity-0"
                             data-taos-offset="400">
                            <img src="{{ asset('images/photos/quantum.jpg') }}" class="h-full w-full object-cover rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl transform transition hover:scale-110" alt="placeholder"/>
                        </div>
                        <div class="size-36 2xl:size-52 3xl:size-72 delay-300 duration-1000 taos:scale-75 taos:opacity-0"
                             data-taos-offset="400">
                            <img src="{{ asset('images/photos/lasertag.jpg') }}" class="h-full w-full object-cover rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl transform transition hover:scale-110" alt="placeholder"/>
                        </div>
                    </div>
                </div>
            </div>
