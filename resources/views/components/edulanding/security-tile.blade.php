<section class="relative overflow-hidden py-12 lg:py-48 z-10">
    <div
        class="relative overflow-hidden px-4 sm:px-6 lg:px-12 mx-auto py-16 lg:py-36 bg-edu-gray-dark flex items-center justify-center max-w-7xl rounded-2xl">
        ...
        <div class="flex flex-col items-center justify-center gap-y-4 relative z-10 text-white">
            <div class="text-3xl md:text-4xl text-center">
                <h2 class="font-medium leading-7 md:leading-tight">
                    <span class="inline">{{ $title }}</span>
                </h2>
            </div>
            <p class="leading-6 lg:leading-7 text-md max-w-3xl text-center">
                {{ $description }}
            </p>
        </div>
    </div>
