<div class="relative flex mx-auto max-w-4xl place-content-center">
    ...
    <img src="{{ asset('graphics/main_project/with_frame.webp') }}" class="h-[550px] w-[750px] max-w-4xl hidden md:block" alt=""/>
    <img src="{{ asset('graphics/main_project/no_frame.webp') }}" class="h-auto w-full max-w-4xl md:hidden block mb-8" alt=""/>
