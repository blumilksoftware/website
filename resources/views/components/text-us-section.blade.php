<section class="relative mx-[10%] 2xl:max-w-[1340px] 2xl:mx-auto">
    <div class="w-full pb-10 pt-12 md:pt-24 sm:py-32">
        <div class="relative isolate overflow-hidden bg-blue-normal py-8 md:py-16 text-center shadow-2xl px-8 max-h-[417px] rounded-3xl">
            ...
            <h2 class="mx-auto max-w-5xl text-3xl font-bold tracking-tight text-white sm:text-5xl">{{ __("content.home.section_7.title_1") }}</h2>
            <p class="mx-auto max-w-7xl mt-6 text-xs md:text-lg leading-7 text-gray-200">{{ __("content.home.section_7.subtitle_1") }}
                <span class="font-bold text-white block">{{ __("content.home.section_7.subtitle_2") }}</span>
            </p>
