<section class="relative mx-[10%] 2xl:max-w-screen-2xl 2xl:mx-auto">
    <div class="w-full py-10 sm:py-32">
        <div class="relative isolate overflow-hidden bg-blue-normal py-10 md:py-24 text-center shadow-2xl px-8  rounded-3xl">
            ...
            <p class="mx-auto max-w-7xl mt-6 text-sm md:text-lg leading-relaxed text-gray-300">{{ __("content.home.section_6.subtitle_1") }}
