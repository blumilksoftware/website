            ...
            <div class="flex basis-2/5 relative flex-col self-center gap-5">
                ...
                <div class="flex flex-col items-center xl:items-start">
                    <p class="text-sm sm:text-lg lg:text-xl font-light text-center xl:text-start pb-10">
                        <span class="leading-loose">{{ __("content.home.section_1.subtitle_1") }}</span>
                        <span class="font-semibold leading-loose">{{ __("content.home.section_1.subtitle_2") }}</span>
                    </p>
        ...
        <section class="relative">
            <div class="mx-[10%] lg:mx-[15%] 2xl:max-w-7xl 2xl:mx-auto space-y-10 pt-8 sm:pt-20 lg:pt-40 lg:pb-28">
                <div class="pb-6 lg:pb-14 text-center">
                    ...
                    <span class="font-light leading-loose text-sm sm:text-md lg:text-lg relative">{{ __("content.home.section_3.subtitle_1") }}</span>
                </div>
