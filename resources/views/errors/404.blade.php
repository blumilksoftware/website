...
@section('message')
    <section class="flex flex-col-reverse xl:flex-row pt-8 md:pt-10 mx-[10%] lg:mx-[15%] 2xl:max-w-7xl 2xl:mx-auto gap-5">
        <div class="flex basis-2/5 relative flex-col self-center gap-5">
            ...
            <div class="flex flex-col items-center xl:items-start">
                <p class="text-sm sm:text-md lg:text-lg font-normal text-center xl:text-start leading-loose md:leading-relaxed">
                    <span class="block pb-6 pr-20">{{ __("content.404.subtitle_1") }}</span>
        ...
        <div class="flex basis-3/5 relative self-center pb-8 md:pb-24 xl:pb-0 left-16">
