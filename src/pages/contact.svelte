...
<Section classes="mb-24">
    ...
    <div slot="content">
        <img class="px-12 lg:p-12 relative z-10 pointer-events-none" src="/images/illustrations/contact.svg" alt="{ $_('pages.contact.header') }" title="{ $_('pages.contact.header') }">
    </div>
</Section>
