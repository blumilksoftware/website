    ...
    <div class="flex-1">
        <ContentSection title="Contact us">
            <form>
                ...
                <div class="px-12 py-4">
                    <div class="text-center px-4 py-2 mt-1 block w-full rounded-md bg-blue-500 text-white">
        ...
        <ContentSection title="Visit us">
            <p class="text-lg text-justify">
                ...
                The railway station is less than 10 minutes by foot.
            </p>
        </ContentSection>
    </div>
    <div class="flex-1">
...
<script>
  ...
  export let emailName = global.env.CONTACT_FORM_EMAIL_NAME + '/formResponse'
  export let questionName = global.env.CONTANT_FORM_QUESTION_NAME + '/formResponse'
</script>
