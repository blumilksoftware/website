...
<Section>
    ...
    <div slot="content">
        <img class="p-12" src="/images/illustrations/rnd.svg" alt="{ $_('pages.services.r&d.header') }" data-cy="rnd-image"
...
<Section classes="lg:flex-row-reverse">
    ...
    <div slot="content">
        <img class="p-12" src="/images/illustrations/web.svg" alt="{ $_('pages.services.web.header') }"
...
<Section>
    ...
    <div slot="content">
        <img class="p-12" src="/images/illustrations/data.svg" alt="{ $_('pages.services.business.header') }"
